        ...
        <section className="py-24 bg-[linear-gradient(135deg,#d4af37,#f2d57a_38%,#1f8f76)] text-black relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Button asChild size="lg" className="h-14 px-8 text-lg rounded-full bg-black text-white hover:bg-black/80">
                        <Link href="/contact">Book Your Free Session</Link>
                    </Button>
                    <Button asChild size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full border-black text-black hover:bg-black/10">
